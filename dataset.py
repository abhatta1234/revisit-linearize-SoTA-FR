...
###### this code is for the hsv loader #########

#overriding the default source code loader
def pil_loader_hsv(path: str) -> Image.Image:
...
def get_dataloader(
    ...
    # Image Folder
        ...
        #train_set = ImageFolder(root_dir, transform,loader=pil_loader_hsv)
